...
<!-- View submit existing scammer page-->
@section('container')
<div class="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Add new report to an existing scammer (* is required)</li>
          </ol>
          ...
          @endif
        <form action="/scammer/new/report/{{ $scammer->slug }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="box_general padding_bottom">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="bank_name" required value="{{ old('bank_name') }}" class="form-control" placeholder="Maybank/Bank Islam/Cimb">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Account Number*</label>
                                <input type="text" name="bank_account" required value="{{ old('bank_account') }}" class="form-control" placeholder="158234654136">
                            </div>
                        </div>
                    </div>
                </div>
